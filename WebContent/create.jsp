...
Issue Name: <input type="text" required="required" name="issueName"><br><br>
...
<br><br>
Issue Project: <input type="text" required="required" name="issueProject"><br><br>
Issue Client: <input type="text" required="required" name="issueClient"><br><br>
